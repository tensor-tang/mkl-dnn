...
/*
namespace {
void pick_loop_order(jit_concat_conf_t &jcp)
{
...
void jit_avx512_concat_kernel::prepare_output(int ur_w)
{
...
#ifdef FUSE_CONV
void jit_avx512_concat_kernel::prepare_1x1output(int ur_w)
{
    Label l_first_load, l_ret;
...
void jit_avx512_concat_kernel::store_1x1output(int ur_w, int ocb1x1)
{
...
void jit_avx512_concat_kernel::store_output(int ur_w)
{
    Label l_update_acc, l_ret;
...
void jit_avx512_concat_kernel::compute_loop(int ur_w,
    int pad_l, int pad_r)
{
    int kw = jcp.kw;
